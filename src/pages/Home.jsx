    ...
    <Container maxWidth={false} disableGutters>
      ...
      >
        ...
        >
          ...
          <Grid item xs={12} sx={{ textAlign: "center" }}>
            ...
            >
              {kor?"비트나인의 DB 기술과 PG 전문성의 융합":"An integration of Bitnine’s DB technology and PG expertise"}
            </Typography>
            <Paragraph>
              {kor?"AgensSQL은 수년간의 전문성을 갖춘 PostgreSQL 기반의 완전히 새로운 관계형 DBMS입니다.\n"+
                 "데이터베이스 연구 개발을 통해 축적된 지식." : "AgensSQL is an all-new relational DBMS based on PostgreSQL, with years of expertise \n and knowledge accumulated through database research and development."}
            </Paragraph>
            <Paragraph>
              {kor?"엔터프라이즈 패키지는 AgensSQL 엔진과 함께 \n"+
                 "데이터 관리의 효율성과 확장성.":"The enterprise package, along with AgensSQL engine, is an"+
              "all-in-one solution that \n ensures the efficiency and"+
              "scalability of data management."}
            </Paragraph>
            <Paragraph>
              {kor? "저렴한 비용으로 안정적인 운영 및 관리 서비스를 위해 지금 AgensSQL을 받으세요. \n"+
              "유지 보수 비용.":"Get AgensSQL now for stable operation and management services at a"+
              "reduced \n maintenance cost."}
            </Paragraph>
          </Grid>
        </Grid>
      ...
      >
        <Grid item mb={2} xs={12}>
          ...
          <Paragraph>
            {kor?"Agens Enterprise Package로 데이터 관리 \n"+
            "고가용성 및 샤딩과 같은 필수 엔터프라이즈 기능 제공":"Manage your data with Agens Enterprise Package \n"+
      ...
      >
        <Grid item mb={2} xs={12}>
          ...
          <Paragraph sx={{ py: 2 }}>
            {kor?"AgensSQL은 PostgreSQL 기반 DBMS입니다. \n 최적의 보안과 안정성을 보장합니다.":"AgensSQL is a PostgreSQL-based DBMS \n that guarantees optimal security and stability."}
          </Paragraph>
        </Grid>
        <Grid item xs={12} sx={{ display: "flex", justifyContent: "center" }}>
      ...
      >
        ...
        <Paragraph>
          {kor?"Agens Enterprise Package는 고가용성 관리 서버와 함께 제공됩니다. \n 기업 고객이 데이터를 효율적으로 관리할 수 있도록 백업 및 데이터 모니터링 대시보드를 지원합니다.":"Agens Enterprise Package comes with a high availability management server that \n supports backup and data monitoring dashboard that helps enterprise customers manage their data efficiently."}
        </Paragraph>

        <Grid container>
          <Grid item xs={12} md={6}>
            <Typography mb={3} variant="h5">{kor?"에이젠스 HA 매니저":"Agens HA Manager"}</Typography>

            <Typography mb={2} variant="h5" sx={{ fontWeight: 400 }}>
              {kor?(<><span style={{ color: "#0082cb" }}>HA 클러스터링</span> – Failover/Failback, 로드밸런싱</>):(<><span style={{ color: "#0082cb" }}>HA Clustering</span> – Failover/Failback, Load-balancing</>)}
            </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Grid container >
              <Grid item mb={3} xs={12}>
                <Typography variant="h5">{kor?(<>에이젠스 엔터프라이즈 매니저</>):(<>Agens Enterprise Manager</>)}</Typography>
              </Grid>
